...
//namespace QuestionPaper.Answers
//{
//    internal class AllAnswers
//    {
//        public static void QuestionOne()
//        {
//            //Que-1:-What are Value types? Declare a variable for each Value type, and print its Max Value.
//            /**
...
//            char charOne = 'A';
//            bool boolOne = true;
//            Console.WriteLine(byte.MaxValue);  //(byte.MaxValue) This line is used to write for the max value of value type.
...
//         * After calling Swap, v1 should have v2’s original value, and v2 should have v1’s original value.
//         ***//
